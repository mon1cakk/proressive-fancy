...
import { EVENTTYPES, STATUS_CODE } from "@lesliejs/common";
import {
  getErrorUid,
  hashMapExist,
  getTimestamp,
...
import { ErrorTarget, RouteHistory, HttpData } from "@lesliejs/types";
...
const HandleEvents = {
  ...
  handleError(ev: ErrorTarget): void {
    try {
      ...
      // console.error('lesliejs: handleError错误解析异常:', er);
    }
  },
  ...
  handleUnhandleRejection(ev: PromiseRejectionEvent): void {
    try {
      ...
      // console.error('lesliejs: handleUnhandleRejection错误解析异常:', er);
    }
  },
