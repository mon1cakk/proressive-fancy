import { EVENTTYPES, BREADCRUMBTYPES } from "@lesliejs/common";
import { validateOption, getTimestamp, _support } from "@lesliejs/utils";
import { BreadcrumbData, InitOptions } from "@lesliejs/types";
